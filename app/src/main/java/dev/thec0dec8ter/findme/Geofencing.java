package dev.thec0dec8ter.findme;
...
public class Geofencing {
    ...
    private GeofencingClient mGoogleApiClient;
    private Context mContext;

    public Geofencing(Context context) {
        mContext = context;
        mGoogleApiClient = new GeofencingClient(context);
    ...
    public void registerAllGeofences() {
        ...
        if (mGoogleApiClient == null || !mGoogleApiClient.asGoogleApiClient().isConnected() ||
            ...
            LocationServices.getGeofencingClient(mContext)
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull  Task<Void> task) {
                            Log.e(TAG, String.format("Error adding geofence : %s",
                                    task.isSuccessful()));
                        }
                    });
    ...
    public void unRegisterAllGeofences() {
        ...
        try {
            LocationServices.getGeofencingClient(mContext)
                ...
                @Override
                public void onComplete(@NonNull  Task<Void> task) {
                    Log.e(TAG, String.format("Error removing geofence : %s",
                            task.isSuccessful()));
                }
            });
        } catch (SecurityException securityException) {
